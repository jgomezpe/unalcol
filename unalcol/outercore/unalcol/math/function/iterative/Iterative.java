...
public class Iterative<I, O> extends Function<I, O> {
     ...
     */
    public Iterative( StepFunction<I,O> step, Predicate<Function<I, O>> condition, long delay) {
     ...
     * until the condition is false)
     */
    public Iterative(StepFunction<I,O> step, Predicate<Function<I, O>> condition ) {
