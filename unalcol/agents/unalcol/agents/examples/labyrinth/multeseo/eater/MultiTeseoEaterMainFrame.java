...
public class MultiTeseoEaterMainFrame extends JFrame{
    /**
     * 
     */
    private static final long serialVersionUID = -2769478672030729364L;
    ...
    protected MultiTeseoEaterLabyrinth labyrinth = null;
    ...
    protected WorkingPanel drawArea = 
	    new WorkingPanel( new MultiTeseoEaterLabyrinthDrawer() );
  ...
  //  MultiChart multiChart1 = new MultiChart();
    ...
    public MultiTeseoEaterLabyrinth newLabyrinthInstance(){
      labyrinth = new MultiTeseoEaterLabyrinth( agent, new int[Labyrinth.DEFAULT_SIZE][Labyrinth.DEFAULT_SIZE] );
      return labyrinth;
    }
    ...
    public MultiTeseoEaterMainFrame( Vector<Agent> _agent, SimpleLanguage _language ) {
      this( "Labyrinth", _agent, _language );
    }

    public MultiTeseoEaterMainFrame( String _title, Vector<Agent> _agent, SimpleLanguage _language ) {
      title = _title;
