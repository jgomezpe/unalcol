...
public class Mutation implements Variation_1_1<int[]>, ParameterizedObject<Double> {
   ...
   */
  public Mutation(double bit_mutation_rate, int MAX) {
	  this(MAX);
