 ...
 * @author Thomas Weise
 */
public final class F16 extends ShiftedPermutatedRotatedFunction {
   ...
   *          the rotation matrix
   */
  public F16(final double[] o, final int[] p, final double[] m) {
    super(o, p, m, MIN, MAX);
  }
   ...
   */
  public F16() {
    this(Defaults.getRandomizer(F16.class));
  }
