 ...
 * @author Thomas Weise
 */
public final class F17 extends ShiftedPermutatedFunction {
   ...
   */
  public F17(final double[] o, final int[] p, final int m) {
    super(o, p, MIN, MAX);
    this.m_m = m;
  }
   ...
   */
  public F17() {
    this(Defaults.getRandomizer(F17.class));
  }
