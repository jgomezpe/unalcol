 ...
 * <P>
 *
 * <A HREF="https://github.com/jgomezpe/unalcol/blob/master/src/unalcol/random/raw/rngpack/Ranlux.java">
...
public Ranlux(int lux,Date d) {
    init_arrays();
    rluxgo(lux,(int) (initSeed( d )%Integer.MAX_VALUE) );
};
...
public Ranlux(Date d) {
    init_arrays();
    rluxgo(lxdflt,(int) (initSeed( d )%Integer.MAX_VALUE) );
};
