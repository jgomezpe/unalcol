 ...
 * @author jgomez
 */
public class SparseRealVectorSphereNormalization implements Scale<SparseRealVector>{
   ...
   */
  public SparseRealVector fastApply(SparseRealVector x) { return scale.fastDivide(x, dot.norm(x)); }
}