 ...
 * @author jgomez
 */
public class SparseRealVectorPlainWrite implements SparseRealVectorWrite{
    /**
     ...
     */
    public SparseRealVectorPlainWrite() {}

    /**
     * Creates an integer array persistent method that uses an space for separating the array values
     */
    public SparseRealVectorPlainWrite(boolean write_dim ) {
     ...
     */
    public SparseRealVectorPlainWrite(char separator) {
     ...
     * @param separator Character used for separating the array values
     */
    public SparseRealVectorPlainWrite(char separator, boolean write_dim ) {
        this.separator = separator;
