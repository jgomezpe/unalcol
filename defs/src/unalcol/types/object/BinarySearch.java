...
public class BinarySearch<T> {
     ...
     */
	public BinarySearch(T[] sorted, Order<T> order){
		this.order = order;
		this.sorted = sorted;
	}

	public void set( T[] sorted ){ this.sorted = sorted; } 
     ...
     */
    public int find(T x) { return find( 0, sorted.length, x ); }
     ...
     */
    public int findRight(T x) { return findRight( 0, sorted.length, x ); }
     ...
     */
    public int findLeft(T x){ return findLeft( 0, sorted.length, x ); }
