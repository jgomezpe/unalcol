...
public class ArrayUtil {
	...
	public static <T> int indexForAddToSortArray( int n, T[] a, T x, Order<T> order ){
	...
	public static <T> boolean addToSortArray( int n, T[] a, T x, Order<T> order ){
	...
	public static <T> boolean removeFromSortArray( int n, T[] a, T x, Order<T> order ){
    	if( a.length > 0 && n>0 ){
            BinarySearch<T> search = new BinarySearch<T>(a,order);
	...
	public static <T> int findInSortArray( int n, T[] a, T x,  Order<T> order ){
        BinarySearch<T> search = new BinarySearch<T>(a,order);
