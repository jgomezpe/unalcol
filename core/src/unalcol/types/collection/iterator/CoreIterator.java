...
public abstract class CoreIterator<T> implements UnalcolIterator<T>{
	...
	public CoreIterator( Iterator<T> iter ) { this( iter, MEMORY_SIZE ); }
	
	public CoreIterator( Iterator<T> iter , int n ){
		this.n = n;
		this.iter = iter;
		data = new Object[n];
