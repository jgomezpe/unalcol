    ...
    public static Tracer service( Object caller ){
    	try{ 
    		...
    		Tracer tr = new Tracer() {
    			 ...
    			 * @return <i>true</i> if the Tracer was tracing objects, <i>false</i>otherwise.
    			 */
    			public void start(){ for( String s:set.options() ) ((Tracer)set.get(s)).start(); }

    			/**
    			 * Stops the tracing of objects process
    			 * @return <i>true</i> if the Tracer was tracing objects, <i>false</i>otherwise.
    			 */
    			public void stop(){ for( String s:set.options() ) ((Tracer)set.get(s)).stop(); }
    			 ...
    			 */
    			public Object get(){
    				LowLevelKeyMap<String,Object> v = new LowLevelKeyMap<String,Object>();
