...
import unalcol.optimization.integer.BinaryToIntArray;
...
public class BinaryToRealVector extends CodeDecodeMap<BitArray, double[]>{
    protected BinaryToIntArray lowLevel = null;
    protected RealVectorLinealScale scale = null;
    protected LinealScale one_scale = null;

    public BinaryToRealVector( int _int_size, double[] min, double[] max ){
        lowLevel = new BinaryToIntArray(_int_size);
     ...
     */
    public BinaryToRealVector(int _int_size) {
        lowLevel = new BinaryToIntArray(_int_size);
    ...
    public static void main( String[] args ){
      int n = 32;
      BinaryToRealVector p = new BinaryToRealVector(n);
      for( int i=0; i<10; i++ ){
